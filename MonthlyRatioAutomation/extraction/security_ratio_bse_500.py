...
security_ratio_url = "https://www.valueresearchonline.com/stocks/selector-data/indices/46/bse-500-index/?custom-cols" \
                     "=mcap%2Cpe%2Cpb%2Cdy%2Ceps&output=html-data&draw=1&start=0&length=501 "
...
def get_security_ratio():
    ...
    for data in json.loads(response.content)['data']:
        text_label = ['securtiy_name', 'market_cap', 'price_to_earnings', 'price_to_book', 'dividend_yield',
                      'earning_per_share']
        text_values = []
