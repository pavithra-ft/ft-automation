...
from ..config.amc_dictionary import lnt_dict
from ..config.web_elements import lnt_path
from ..config.selenium_chrome import EXTRACTED_DIR, YEAR


class LTAdvisorKhoj(scrapy.Spider):
    name = "lnt_crawler"
    ...
    def start_requests(self):
        """
        This function will loop through all the AMC's in the given dictionary with the Query parameters of the URL.
