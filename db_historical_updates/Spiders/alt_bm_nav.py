...
from Spiders.db_actions import get_start_price, put_fund_alt_bm_nav, get_alt_benchmark_info, get_nav_dates, \
    get_index_price_as_on_date


def get_alt_benchmark_nav(fund_code, nav_start_date, alt_bm_index, current_date, iq_database):
    ...
    put_fund_alt_bm_nav(fund_code, alt_benchmark_nav, current_date, iq_database)
